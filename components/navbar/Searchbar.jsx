...
export default function Searchbar({ updateReports }) {
    ...
    return (
        <form id='search-bar' onSubmit={handleSubmit} className="flex-1 flex items-center justify-center gap-2">
            <input id='search-input' onChange={handleChange} value={location} className='w-[60%] h-[36px] font-medium flex-1 text-center rounded-full text-white bg-slate-800 focus:bg-slate-700' type="text" placeholder='Search city...' />
